        ...
        <section>
                            ...
                            <div class="card card-plain">
                                ...
                                <div class="card-body">
                                    <form role="form">
                                        ...
                                        <argon-switch id="rememberMe">Manter conectado</argon-switch>
          ...
          background-size: cover;"
                            >
                                ...
                                >Gerencie sua auto eletrica por aqui</h4>
                                <p
                                    class="text-white position-relative"
                                >O melhor sistema pra gerenciar seu negocio, varias funcionalidades pra facilitar sua vida!</p>
                            </div>
                        </div>
                    </div>
                </div>
